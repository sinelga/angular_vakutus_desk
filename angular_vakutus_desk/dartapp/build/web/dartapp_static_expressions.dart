library dartapp.web.dartapp.generated_expressions;
...
final Map<String, FieldGetter> getters = {
  ...
  r"Cont": (o) => o.Cont,
  r"ctrl": (o) => o.ctrl,
  r"navigationListLoaded": (o) => o.navigationListLoaded,
  r"navigationList": (o) => o.navigationList,
  r"navigation": (o) => o.navigation,
  r"SubThemes": (o) => o.SubThemes,
  r"articlesListLoaded": (o) => o.articlesListLoaded,
  r"articleSelected": (o) => o.articleSelected,
  r"articlesList": (o) => o.articlesList,
  r"article": (o) => o.article,
  r"selectedArticles": (o) => o.selectedArticles,
  r"selectNavigation": (o) => o.selectNavigation,
...
final Map<String, FieldSetter> setters = {
  ...
  r"Cont": (o, v) => o.Cont = v,
  r"ctrl": (o, v) => o.ctrl = v,
  r"navigationListLoaded": (o, v) => o.navigationListLoaded = v,
  r"navigationList": (o, v) => o.navigationList = v,
  r"navigation": (o, v) => o.navigation = v,
  r"SubThemes": (o, v) => o.SubThemes = v,
  r"articlesListLoaded": (o, v) => o.articlesListLoaded = v,
  r"articleSelected": (o, v) => o.articleSelected = v,
  r"articlesList": (o, v) => o.articlesList = v,
