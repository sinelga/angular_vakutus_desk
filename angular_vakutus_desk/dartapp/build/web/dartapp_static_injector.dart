library dartapp.web.dartapp.generated_static_injector;
...
import 'package:dartapp/recipe_book.dart' as import_16;
import 'package:dartapp/smallarticle/smallarticle_component.dart' as import_17;
import 'package:dartapp/bigarticle/bigarticle_component.dart' as import_18;
...
final Map<Type, TypeFactory> factories = <Type, TypeFactory>{
  ...
  import_16.RecipeBookController: (f) => new import_16.RecipeBookController(),
  import_17.SmallArticleComponent: (f) => new import_17.SmallArticleComponent(),
  import_18.BigArticleComponent: (f) => new import_18.BigArticleComponent(),
