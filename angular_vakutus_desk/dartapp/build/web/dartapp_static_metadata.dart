library dartapp.web.dartapp.generated_metadata;
...
import 'package:dartapp/recipe_book.dart' as import_5;
import 'package:dartapp/smallarticle/smallarticle_component.dart' as import_6;
import 'package:dartapp/bigarticle/bigarticle_component.dart' as import_7;
...
final Map<Type, Object> typeAnnotations = {
  ...
  import_5.RecipeBookController: const [
    const import_1.Controller(selector: '[recipe-book]', publishAs: 'ctrl'),
  ],
  import_6.SmallArticleComponent: const [
    const import_1.Component(selector: 'smallarticle', templateUrl: 'packages/dartapp/smallarticle/smallarticle_component.html', applyAuthorStyles: true, cssUrl: 'packages/dartapp/smallarticle/smallarticle_component.css', publishAs: 'cmp', map: const {'articelobj': '=>articelobj'}),
  ],
  import_7.BigArticleComponent: const [
